---
name: jollyday
description: A Java library for querying public holidays supporting 210+ countries with XML-based holiday calendar configuration
---
...
**Jollyday** is a Java library to query public holidays. It currently supports **over 210 countries**. The holiday data is stored in XML files (one for each country) and will be read from the classpath.

### Key Features

- Supports 210+ countries with public holiday data
