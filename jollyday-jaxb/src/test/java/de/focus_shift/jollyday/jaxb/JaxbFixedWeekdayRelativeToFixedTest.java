...
class JaxbFixedWeekdayRelativeToFixedTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    final JaxbFixedWeekdayRelativeToFixed jaxbFixedWeekdayRelativeToFixed =
        new JaxbFixedWeekdayRelativeToFixed(fixedWeekdayRelativeToFixed);
    assertThat(jaxbFixedWeekdayRelativeToFixed.day().day())
    ...
    assertThat(jaxbFixedWeekdayRelativeToFixed.descriptionPropertiesKey())
