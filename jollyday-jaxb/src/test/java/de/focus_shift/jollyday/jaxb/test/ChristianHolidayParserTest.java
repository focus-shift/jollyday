...
import static de.focus_shift.jollyday.jaxb.mapping.ChristianHolidayType.CLEAN_MONDAY;
import static de.focus_shift.jollyday.jaxb.mapping.ChristianHolidayType.EASTER;
import static de.focus_shift.jollyday.jaxb.mapping.ChristianHolidayType.EASTER_SATURDAY;
import static de.focus_shift.jollyday.jaxb.mapping.ChristianHolidayType.EASTER_TUESDAY;
import static de.focus_shift.jollyday.jaxb.mapping.ChristianHolidayType.GENERAL_PRAYER_DAY;
import static de.focus_shift.jollyday.jaxb.mapping.ChristianHolidayType.PENTECOST;
import static de.focus_shift.jollyday.jaxb.mapping.ChristianHolidayType.SACRED_HEART;
...
class ChristianHolidayParserTest {
  ...
  void testRelativeToEasterSunday() {
    ...
    final List<Holiday> holidays = p.parse(Year.of(2011), new JaxbHolidays(config));
  ...
  void testCustomPropertiesKey() {
    ...
    final List<Holiday> holidays = sut.parse(Year.of(2019), new JaxbHolidays(config));
