...
class JaxbFixedWeekdayBetweenFixedTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    final JaxbFixedWeekdayBetweenFixed jaxbFixedWeekdayBetweenFixed =
        new JaxbFixedWeekdayBetweenFixed(fixedWeekdayBetweenFixed);
    ...
    assertThat(jaxbFixedWeekdayBetweenFixed.descriptionPropertiesKey())
        .isEqualTo("between.description");
    assertThat(jaxbFixedWeekdayBetweenFixed.holidayType())
