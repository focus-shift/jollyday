...
class JaxbRelativeToWeekdayInMonthTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    relativeToWeekdayInMonth.setLocalizedType(
        de.focus_shift.jollyday.jaxb.mapping.HolidayType.BANK_HOLIDAY);
    ...
    final JaxbRelativeToWeekdayInMonth jaxbRelativeToWeekdayInMonth =
        new JaxbRelativeToWeekdayInMonth(relativeToWeekdayInMonth);
    ...
    assertThat(jaxbRelativeToWeekdayInMonth.weekdayInMonth().month())
    ...
    assertThat(jaxbRelativeToWeekdayInMonth.descriptionPropertiesKey())
