...
class JaxbFixedWeekdayInMonthTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    final JaxbFixedWeekdayInMonth jaxbFixedWeekdayInMonth =
        new JaxbFixedWeekdayInMonth(fixedWeekdayInMonth);
    ...
    assertThat(jaxbFixedWeekdayInMonth.descriptionPropertiesKey())
        .isEqualTo("weekdayinmonth.description");
    assertThat(jaxbFixedWeekdayInMonth.holidayType())
