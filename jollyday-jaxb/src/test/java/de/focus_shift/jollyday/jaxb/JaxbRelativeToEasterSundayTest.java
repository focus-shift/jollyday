...
class JaxbRelativeToEasterSundayTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    relativeToEasterSunday.setLocalizedType(
    ...
    final JaxbRelativeToEasterSunday jaxbRelativeToEasterSunday =
        new JaxbRelativeToEasterSunday(relativeToEasterSunday);
    ...
    assertThat(jaxbRelativeToEasterSunday.descriptionPropertiesKey())
        .isEqualTo("easter.description");
