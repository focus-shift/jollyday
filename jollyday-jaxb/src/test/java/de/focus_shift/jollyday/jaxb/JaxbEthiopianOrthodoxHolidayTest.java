...
class JaxbEthiopianOrthodoxHolidayTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    ethiopianOrthodoxHoliday.setType(
        de.focus_shift.jollyday.jaxb.mapping.EthiopianOrthodoxHolidayType.TIMKAT);
    ...
    final JaxbEthiopianOrthodoxHoliday jaxbEthiopianOrthodoxHoliday =
        new JaxbEthiopianOrthodoxHoliday(ethiopianOrthodoxHoliday);
    ...
    assertThat(jaxbEthiopianOrthodoxHoliday.descriptionPropertiesKey())
        .isEqualTo("ethiopian.description");
    assertThat(jaxbEthiopianOrthodoxHoliday.holidayType())
