...
class JavaGenerator {
  ...
  void generateHolidaySource(HolidayCalendar cal, Writer writer) throws IOException{
    ...
    InputStream inputStream = JavaGenerator.class.getClassLoader().getResourceAsStream("holidays/" + holidayFileName);
    if (inputStream == null) {
    ...
    writer.write("package de.focus_shift.jollyday.java.holidays;\n\n");
    writeImports(writer);
    writer.write("import de.focus_shift.jollyday.java.*;\n\n");
  ...
  private void writeHeader(Writer writer) throws IOException{
    writer.write("package de.focus_shift.jollyday.java;\n\n");
  ...
  private String constructor(String... arguments) {
    StringBuilder sb = new StringBuilder();
    sb.append("new %s(");
