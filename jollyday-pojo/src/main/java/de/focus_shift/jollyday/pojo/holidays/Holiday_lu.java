...
public class Holiday_lu {
  ...
  static {
    configuration = new JavaConfiguration(new JavaHolidays()
      ...
      .addFixed(new JavaFixed("EUROPE_DAY", HolidayType.OFFICIAL_HOLIDAY, Year.of(2019), null, YearCycle.EVERY_YEAR, null, MonthDay.of(5, 9)))
      .addFixed(new JavaFixed("NATIONAL_DAY", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, null, MonthDay.of(6, 23)))
      ...
      , List.of(new JavaConfiguration(new JavaHolidays()
      .addFixed(new JavaFixed("CARNIVAL", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, null, MonthDay.of(2, 15)))
      , null, "clu", "City of Luxembourg")), "lu", "Luxembourg")), "lu", "Luxembourg");
  }
}
