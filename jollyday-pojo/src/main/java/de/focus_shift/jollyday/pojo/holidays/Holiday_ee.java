...
public class Holiday_ee {
  ...
  static {
    configuration = new JavaConfiguration(new JavaHolidays()
      ...
      .addFixed(new JavaFixed("INDEPENDENCE_DAY", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, null, MonthDay.of(2, 24)))
      .addFixed(new JavaFixed("VICTORY", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, null, MonthDay.of(6, 23)))
      .addFixed(new JavaFixed("MIDSUMMER", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, null, MonthDay.of(6, 24)))
      .addFixed(new JavaFixed("REST_INDEP", HolidayType.OFFICIAL_HOLIDAY, Year.of(1991), null, YearCycle.EVERY_YEAR, null, MonthDay.of(8, 20)))
