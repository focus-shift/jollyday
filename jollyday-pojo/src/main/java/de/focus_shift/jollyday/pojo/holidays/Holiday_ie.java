...
public class Holiday_ie {
  ...
  static {
    configuration = new JavaConfiguration(new JavaHolidays()
      ...
      .addFixed(new JavaFixed("ST_PATRICK", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, null, MonthDay.of(3, 17)))
      ...
      .addFixedWeekday(new JavaFixedWeekdayInMonth("BANK_HOLIDAY", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, DayOfWeek.of(1), Month.of(6), Occurrance.FIRST))
      .addFixedWeekday(new JavaFixedWeekdayInMonth("BANK_HOLIDAY", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, DayOfWeek.of(1), Month.of(8), Occurrance.FIRST))
      .addFixedWeekday(new JavaFixedWeekdayInMonth("BANK_HOLIDAY", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, DayOfWeek.of(1), Month.of(10), Occurrance.LAST))
      , null, "ie", "Ireland");
  }
}
