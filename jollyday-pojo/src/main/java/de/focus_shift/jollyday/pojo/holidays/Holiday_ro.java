...
public class Holiday_ro {
  ...
  static {
    configuration = new JavaConfiguration(new JavaHolidays()
      ...
      .addFixed(new JavaFixed("UNIFICATION", HolidayType.OFFICIAL_HOLIDAY, Year.of(2017), null, YearCycle.EVERY_YEAR, null, MonthDay.of(1, 24)))
      .addFixed(new JavaFixed("LABOUR_DAY", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, null, MonthDay.of(5, 1)))
      .addFixed(new JavaFixed("CHILDRENS_DAY", HolidayType.OFFICIAL_HOLIDAY, Year.of(2017), null, YearCycle.EVERY_YEAR, null, MonthDay.of(6, 1)))
      .addFixed(new JavaFixed("NAVY_DAY", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, null, MonthDay.of(8, 15)))
      .addFixed(new JavaFixed("ST_ANDREW", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, null, MonthDay.of(11, 30)))
      .addFixed(new JavaFixed("NATIONAL_DAY", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, null, MonthDay.of(12, 1)))
      ...
      .addChristianHoliday(new JavaChristianHoliday("christian.GOOD_FRIDAY", HolidayType.OFFICIAL_HOLIDAY, Year.of(2018), null, YearCycle.EVERY_YEAR, null, ChristianHolidayType.GOOD_FRIDAY, Chronology.of("Julian")))
      ...
      .addChristianHoliday(new JavaChristianHoliday("christian.PENTECOST", HolidayType.OFFICIAL_HOLIDAY, null, null, YearCycle.EVERY_YEAR, null, ChristianHolidayType.PENTECOST, Chronology.of("Julian")))
