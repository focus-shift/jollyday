...
public class Holiday_gg {
  ...
  static {
    configuration = new JavaConfiguration(new JavaHolidays()
      ...
      .addFixed(new JavaFixed("LIBERATION", HolidayType.OFFICIAL_HOLIDAY, null, Year.of(2009), YearCycle.EVERY_YEAR, null, MonthDay.of(5, 9)))
      .addFixed(new JavaFixed("LIBERATION", HolidayType.OFFICIAL_HOLIDAY, Year.of(2010), Year.of(2010), YearCycle.EVERY_YEAR, null, MonthDay.of(5, 10)))
      .addFixed(new JavaFixed("LIBERATION", HolidayType.OFFICIAL_HOLIDAY, Year.of(2011), null, YearCycle.EVERY_YEAR, null, MonthDay.of(5, 9)))
      ...
      .addFixed(new JavaFixed("MAY_DAY_BANK_HOLIDAY", HolidayType.OFFICIAL_HOLIDAY, Year.of(2020), Year.of(2020), YearCycle.EVERY_YEAR, null, MonthDay.of(5, 8)))
      ...
      .addFixedWeekday(new JavaFixedWeekdayInMonth("MAY_DAY_BANK_HOLIDAY", HolidayType.OFFICIAL_HOLIDAY, Year.of(1900), Year.of(2019), YearCycle.EVERY_YEAR, DayOfWeek.of(1), Month.of(5), Occurrance.FIRST))
      .addFixedWeekday(new JavaFixedWeekdayInMonth("MAY_DAY_BANK_HOLIDAY", HolidayType.OFFICIAL_HOLIDAY, Year.of(2021), null, YearCycle.EVERY_YEAR, DayOfWeek.of(1), Month.of(5), Occurrance.FIRST))
      .addFixedWeekday(new JavaFixedWeekdayInMonth("SPRING_BANK_HOLIDAY", HolidayType.OFFICIAL_HOLIDAY, null, Year.of(2021), YearCycle.EVERY_YEAR, DayOfWeek.of(1), Month.of(5), Occurrance.LAST))
