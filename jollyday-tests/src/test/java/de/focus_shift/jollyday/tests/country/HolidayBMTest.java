...
class HolidayBMTest extends AbstractCountryTestBase {
  ...
  @ParameterizedTest
  @ValueSource(
      strings = {"2015", "2016", "2017", "2018", "2020", "2021", "2022", "2023", "2024", "2025"})
  ...
  void testManagerBMInterval() {
    try {
      final HolidayManager instance =
          HolidayManager.getInstance(ManagerParameters.create(HolidayCalendar.BERMUDA, null));
