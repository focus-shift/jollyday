...
class HolidayMKTest {
  ...
  void ensuresHolidays() {
    assertFor(MACEDONIA)
        ...
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("CYRUS_METHODIUS", MAY, 24)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("REPUBLIC_DAY", AUGUST, 2)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("INDEPENDENCE_DAY", SEPTEMBER, 8)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("REVOLUTION", OCTOBER, 11)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("NATIONAL_DAY", OCTOBER, 23)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("SAINT_CLEMENT", DECEMBER, 8)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
