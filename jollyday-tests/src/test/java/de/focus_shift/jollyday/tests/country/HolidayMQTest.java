...
import static de.focus_shift.jollyday.core.HolidayCalendar.MARTINIQUE;
...
class HolidayMQTest {
  ...
  void ensuresHolidays() {
    assertFor(MARTINIQUE)
      ...
      .hasFixedHoliday("ABOLITION_OF_SLAVERY", MAY, 22).validBetween(YEAR_FROM, YEAR_TO).and()
