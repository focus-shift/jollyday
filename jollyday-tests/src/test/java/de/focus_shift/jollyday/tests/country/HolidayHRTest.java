  ...
  void ensuresHolidays() {
    ...
    assertFor(CROATIA)
      ...
      .hasFixedHoliday("NATIONAL_DAY", MAY, 30)
        .notBetween(Year.of(1900), Year.of(2019))
        .between(Year.of(2020), Year.of(2500))
      .and()
      .hasFixedHoliday("ANTI_FASCIST", JUNE, 22).and()
      .hasFixedHoliday("STATEHOOD", JUNE, 25)
        .notBetween(Year.of(1900), Year.of(2001))
        .between(Year.of(2002), Year.of(2019))
        .notBetween(Year.of(2020), Year.of(2500))
      .and()
