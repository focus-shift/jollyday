...
import static de.focus_shift.jollyday.core.HolidayCalendar.UZBEKISTAN;
...
class HolidayUZTest {
  ...
  void ensuresHolidays() {
    assertFor(UZBEKISTAN)
      ...
      .hasFixedHoliday("INDEPENDENCE_DAY", SEPTEMBER, 1).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("TEACHERS_DAY", OCTOBER, 1).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("CONSTITUTION_DAY", DECEMBER, 8).validBetween(YEAR_FROM, YEAR_TO).and()
