...
class HolidayLTTest {
  ...
  void ensuresHolidays() {
    assertFor(LITHUANIA)
        ...
        .and()
        .hasFixedHoliday("UNIFICATION", FEBRUARY, 16)
        .and()
        .hasFixedHoliday("INDEPENDENCE_DAY", MARCH, 11)
        .and()
        .hasFixedHoliday("LABOUR_DAY", MAY, 1)
        .and()
        .hasFixedHoliday("JOHANNIS_DAY", JUNE, 24)
        .and()
        .hasFixedHoliday("STATEHOOD", JULY, 6)
        .and()
        ...
        .and()
        .hasFixedHoliday("CHRISTMAS_EVE", DECEMBER, 25)
        .and()
