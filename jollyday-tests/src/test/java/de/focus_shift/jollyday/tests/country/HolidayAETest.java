...
class HolidayAETest {
  ...
  void ensuresHolidays() {
    assertFor(UNITED_ARAB_EMIRATES)
        ...
        .and()
        .hasFixedHoliday("AE_COMMEMORATION_DAY", DECEMBER, 1)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("NATIONAL_DAY", DECEMBER, 2)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("NATIONAL_DAY", DECEMBER, 3)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasIslamicHoliday("RAMADAN_END")
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
