...
class HolidayETTest {
  ...
  void ensuresHolidays() {
    assertFor(ETHIOPIA)
        ...
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("VICTORY_ADWA", MARCH, 2)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("LABOUR_DAY", MAY, 1)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("VICTORY", MAY, 5)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("NATIONAL_DAY", MAY, 28)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasIslamicHoliday("RAMADAN")
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        ...
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasEthiopianOrthodoxHoliday("TIMKAT")
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasEthiopianOrthodoxHoliday("ENKUTATASH")
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasEthiopianOrthodoxHoliday("MESKEL")
        .validBetween(YEAR_FROM, YEAR_TO)
        .check();
  }
}
