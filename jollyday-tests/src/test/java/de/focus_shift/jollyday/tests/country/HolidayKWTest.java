...
import static de.focus_shift.jollyday.core.HolidayCalendar.KUWAIT;
...
class HolidayKWTest {
  ...
  void ensuresHolidays() {
    assertFor(KUWAIT)
      ...
      .hasFixedHoliday("NATIONAL_DAY", FEBRUARY, 25).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("LIBERATION_DAY", FEBRUARY, 26).validBetween(YEAR_FROM, YEAR_TO).and()
