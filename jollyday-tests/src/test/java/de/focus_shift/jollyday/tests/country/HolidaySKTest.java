  ...
  void ensuresHolidays() {
    assertFor(SLOWAKIA)
      .hasFixedHoliday("FOUNDATION", JANUARY, 1)
        .notBetween(Year.of(1900), Year.of(1992))
        .between(Year.of(1993), Year.of(2500))
      .and()
      .hasFixedHoliday("EPIPHANY", JANUARY, 6).and()
      .hasFixedHoliday("LABOUR_DAY", MAY, 1)
        .notBetween(Year.of(1800), Year.of(1885))
        .between(Year.of(1886), Year.of(2500))
      .and()
      ...
      .hasFixedHoliday("CONSTITUTION_DAY", SEPTEMBER, 1)
        .between(Year.of(1900), Year.of(2024))
        .notBetween(Year.of(2025), Year.of(2500))
      .and()
