...
import static de.focus_shift.jollyday.core.HolidayCalendar.SOMALIA;
...
class HolidaySOTest {
  ...
  void ensuresHolidays() {
    assertFor(SOMALIA)
      ...
      .hasFixedHoliday("REPUBLIC_DAY", JULY, 1).validBetween(YEAR_FROM, YEAR_TO).and()
      ...
      .hasIslamicHoliday("ASCHURA").validBetween(YEAR_FROM, YEAR_TO)
      .check();
  }
}
