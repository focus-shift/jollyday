...
class HolidayVETest {
  ...
  void ensuresHolidays() {
    assertFor(VENEZUELA)
        ...
        .and()
        .hasFixedHoliday("REPUBLIC_DAY", APRIL, 19)
        .and()
        .hasFixedHoliday("LABOUR_DAY", MAY, 1)
        .and()
        .hasFixedHoliday("CARABOBO", JUNE, 24)
        .and()
        .hasFixedHoliday("INDEPENDENCE_DAY", JULY, 5)
        .and()
        .hasFixedHoliday("NAVY_DAY", JULY, 24)
        .and()
        .hasFixedHoliday("FLAG_DAY", AUGUST, 3)
        .notValidBetween(Year.of(1900), Year.of(2005))
        .validFrom(Year.of(2006))
        .and()
        .hasFixedHoliday("INDIGENOUS_RESISTANCE", OCTOBER, 12)
        .and()
        ...
        .and()
        .hasChristianHoliday("SHROVE_MONDAY")
        .and()
