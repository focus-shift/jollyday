...
class HolidayAMTest {
  ...
  void ensuresHolidays() {
    ...
    assertFor(ARMENIA)
        ...
        .and()
        .hasFixedHoliday("CHRISTMAS", JANUARY, 5)
        .and()
        .hasFixedHoliday("CHRISTMAS", JANUARY, 6)
        .and()
        .hasFixedHoliday("ARMY_DAY", JANUARY, 28)
        .and()
        .hasFixedHoliday("INTERNATIONAL_WOMAN", MARCH, 8)
        .and()
        .hasFixedHoliday("ARMENIAN_GENOCIDE_REMEMBRANCE_DAY", APRIL, 24)
        .and()
        .hasFixedHoliday("LABOUR_DAY", MAY, 1)
        .and()
        .hasFixedHoliday("VICTORY_AND_PEACE_DAY", MAY, 9)
        .and()
        .hasFixedHoliday("REPUBLIC_DAY", MAY, 28)
        .and()
        .hasFixedHoliday("CONSTITUTION_DAY", JULY, 5)
        .and()
