...
class HolidayCZTest {
  ...
  void ensuresHolidays() {
    assertFor(CZECH_REPUBLIC)
        ...
        .and()
        .hasFixedHoliday("LIBERATION", MAY, 8)
        .and()
        .hasFixedHoliday("CYRUS_METHODIUS", JULY, 5)
        .and()
        .hasFixedHoliday("HUS", JULY, 6)
        .and()
        .hasFixedHoliday("WENCELAS", SEPTEMBER, 28)
        .and()
        .hasFixedHoliday("INDEPENDENCE_DAY", OCTOBER, 28)
        .and()
        .hasFixedHoliday("FREEDOM_DEMOCRACY", NOVEMBER, 17)
        .and()
