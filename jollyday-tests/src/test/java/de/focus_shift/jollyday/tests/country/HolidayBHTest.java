...
import static de.focus_shift.jollyday.core.HolidayCalendar.BAHRAIN;
...
class HolidayBHTest {
  ...
  void ensuresHolidays() {
    assertFor(BAHRAIN)
      ...
      .hasFixedHoliday("SPORTS_DAY", FEBRUARY, 22).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("LABOUR_DAY", MAY, 1).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("NATIONAL_DAY", DECEMBER, 16).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("NATIONAL_DAY", DECEMBER, 17).validBetween(YEAR_FROM, YEAR_TO).and()
