...
import static de.focus_shift.jollyday.core.HolidayCalendar.GABON;
...
class HolidayGATest {
  ...
  void ensuresHolidays() {
    ...
    assertFor(GABON)
      ...
      .hasFixedHoliday("WOMENS_DAY", APRIL, 17).validBetween(YEAR_FROM, YEAR_TO).and()
      ...
      .hasFixedHoliday("INDEPENDENCE_DAY", AUGUST, 16).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("INDEPENDENCE_DAY", AUGUST, 17).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("LIBERATION", AUGUST, 30).validBetween(YEAR_FROM, YEAR_TO).and()
