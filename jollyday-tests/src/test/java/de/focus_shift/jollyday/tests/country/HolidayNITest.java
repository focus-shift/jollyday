...
class HolidayNITest {
  ...
  void ensuresHolidays() {
    assertFor(NICARAGUA)
        ...
        .and()
        .hasFixedHoliday("AIR_FORCE_DAY", FEBRUARY, 1)
        .and()
        .hasFixedHoliday("LABOUR_DAY", MAY, 1)
        .and()
        .hasFixedHoliday("ARMY_DAY", MAY, 27)
        .and()
        .hasFixedHoliday("LIBERATION", JULY, 19)
        .and()
        .hasFixedHoliday("BATTLE_JACINTO", SEPTEMBER, 14)
        .and()
        .hasFixedHoliday("INDEPENDENCE_DAY", SEPTEMBER, 15)
        .and()
