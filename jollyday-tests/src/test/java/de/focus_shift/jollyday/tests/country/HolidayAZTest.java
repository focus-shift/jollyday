...
class HolidayAZTest {
  ...
  void ensuresHolidays() {
    assertFor(AZERBAIJAN)
      ...
      .hasFixedHoliday("AZERBAIJAN_MARTYRS_DAY", JANUARY, 20).validBetween(YEAR_FROM, YEAR_TO).and()
      // Women's Day
      ...
      .hasFixedHoliday("AZERBAIJAN_NATIONAL_SALVATION_DAY", JUNE, 15).validBetween(YEAR_FROM, YEAR_TO).and()
      // Azerbaijan Armed Forces Day
      .hasFixedHoliday("AZERBAIJAN_ARMED_FORCES_DAY", JUNE, 26).validBetween(YEAR_FROM, YEAR_TO).and()
      // Victory Day (2020 Nagorno-Karabakh war)
      .hasFixedHoliday("AZERBAIJAN_VICTORY_DAY", NOVEMBER, 8).validBetween(YEAR_FROM, YEAR_TO).and()
      // State Flag Day
      .hasFixedHoliday("AZERBAIJAN_STATE_FLAG_DAY", NOVEMBER, 9).validBetween(YEAR_FROM, YEAR_TO).and()
      // International Solidarity Day of Azerbaijanis
      .hasFixedHoliday("AZERBAIJAN_INTERNATIONAL_SOLIDARITY_DAY", DECEMBER, 31).validBetween(YEAR_FROM, YEAR_TO).and()
      // Eid al-Fitr (2 days)
