...
class HolidayBATest {
  ...
  void ensuresHolidays() {
    assertFor(BOSNIA_HERZIGOWINA)
        ...
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("NEW_YEAR", JANUARY, 14)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("MAY_DAY", MAY, 1)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("ST_GEORGE", MAY, 6)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("ST_VITUS", JUNE, 28)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("ST_PETER", JULY, 12)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("ST_ELIJAH", AUGUST, 2)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("ASSUMPTION_DAY", AUGUST, 15)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("ASSUMPTION_DAY", AUGUST, 28)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("NATIVITY_MARY", SEPTEMBER, 8)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("NATIVITY_MARY", SEPTEMBER, 21)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        ...
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
        .hasFixedHoliday("ST_DEMETRIUS", NOVEMBER, 8)
        .validBetween(YEAR_FROM, YEAR_TO)
        .and()
