...
class HolidayCLTest {
  ...
  void ensuresHolidays() {
    assertFor(CHILE)
        ...
        .and()
        .hasFixedHoliday("NAVY_DAY", MAY, 21)
        .and()
        .hasFixedHoliday("ST_PETER_PAUL", JUNE, 28)
        .and()
        ...
        .and()
        .hasFixedHoliday("NATIONAL_DAY", SEPTEMBER, 18)
        .and()
        .hasFixedHoliday("ARMY_DAY", SEPTEMBER, 19)
        .and()
        .hasFixedHoliday("COLUMBUS_DAY", OCTOBER, 11)
        .and()
