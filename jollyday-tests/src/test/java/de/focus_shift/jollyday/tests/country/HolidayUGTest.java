...
import static de.focus_shift.jollyday.core.HolidayCalendar.UGANDA;
...
class HolidayUGTest {
  ...
  void ensuresHolidays() {
    ...
    assertFor(UGANDA)
      ...
      .hasFixedHoliday("LIBERATION", JANUARY, 26).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("ARCHBISHOP_JANANI_LUWUM_DAY", FEBRUARY, 16).validBetween(YEAR_FROM, YEAR_TO).and()
      ...
      .hasFixedHoliday("MARTYRS_DAY", JUNE, 3).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("NATIONAL_HEROES_DAY", JUNE, 9).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("INDEPENDENCE_DAY", OCTOBER, 9).validBetween(YEAR_FROM, YEAR_TO).and()
