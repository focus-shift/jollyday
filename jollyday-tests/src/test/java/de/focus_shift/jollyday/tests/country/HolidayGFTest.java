...
import static de.focus_shift.jollyday.core.HolidayCalendar.FRENCH_GUIANA;
...
class HolidayGFTest {
  ...
  void ensuresHolidays() {
    assertFor(FRENCH_GUIANA)
      ...
      .hasFixedHoliday("ABOLITION_OF_SLAVERY", JUNE, 10).validBetween(YEAR_FROM, YEAR_TO).and()
