  ...
  void ensuresHolidays() {
    assertFor(ARGENTINA)
      ...
      .hasFixedHoliday("REMEMBRANCE_TRUTH_JUSTICE", MARCH, 24)
        ...
        .between(Year.of(2006), Year.of(2500)).and()
      .hasFixedHoliday("MALVINAS", APRIL, 2)
        .notBetween(Year.of(1900), Year.of(2000))
        .between(Year.of(2001), Year.of(2500)).and()
      ...
      .hasFixedHoliday("COLUMBUS_DAY", OCTOBER, 12)
        ...
        .canBeShiftedFrom(WEDNESDAY, PREVIOUS, MONDAY)
