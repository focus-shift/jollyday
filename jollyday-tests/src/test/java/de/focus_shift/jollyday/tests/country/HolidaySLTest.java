...
import static de.focus_shift.jollyday.core.HolidayCalendar.SIERRA_LEONE;
...
class HolidaySLTest {
  ...
  void ensuresHolidays() {
    assertFor(SIERRA_LEONE)
      .hasFixedHoliday("NEW_YEAR", JANUARY, 1).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("ARMED_FORCES_DAY", FEBRUARY, 18).validBetween(YEAR_FROM, YEAR_TO).and()
