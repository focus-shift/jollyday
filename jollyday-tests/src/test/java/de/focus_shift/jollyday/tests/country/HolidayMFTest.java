...
import static de.focus_shift.jollyday.core.HolidayCalendar.SAINT_MARTIN;
...
class HolidayMFTest {
  ...
  void ensuresHolidays() {
    assertFor(SAINT_MARTIN)
      ...
      // Code du travail Art. L3422-2 designates 27 May, inherited from Guadeloupe; superseded
      // in practice by an interministerial circular of 4 May 2018 which authorized 28 May instead
      .hasFixedHoliday("ABOLITION_OF_SLAVERY", MAY, 27)
        .validBetween(YEAR_FROM, Year.of(2017))
        .notValidBetween(Year.of(2018), YEAR_TO)
      .and()
      .hasFixedHoliday("ABOLITION_OF_SLAVERY", MAY, 28)
