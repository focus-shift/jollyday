...
class JapaneseBridgingHolidayManagerTest {
  ...
  static void beforeAll() {
    System.setProperty(
        "de.focus_shift.jollyday.config.urls",
        "file:./src/test/resources/jollyday-japanese.properties");
  }
  ...
  void ensureToInstantiateHolidayManagerImplementationBasedOnCountry() {
    assertThat(HolidayManager.getInstance(create("test_jp")))
        .isInstanceOf(JapaneseBridgingHolidayManager.class);
  }
