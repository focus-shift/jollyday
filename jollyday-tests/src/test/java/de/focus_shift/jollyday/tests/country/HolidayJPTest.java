...
class HolidayJPTest {
  ...
  void ensuresHolidays() {
    assertFor(JAPAN)
        ...
        .validBetween(Year.of(1948), Year.of(1999))
        .and()
        ...
        .validBetween(Year.of(1996), Year.of(2002))
        .and()
        .hasFixedHoliday("RESPECT_AGED_DAY", SEPTEMBER, 15)
        .validBetween(Year.of(1966), Year.of(2002))
        .and()
        .hasFixedHoliday("HEALTH_SPORTS", OCTOBER, 10)
        .validBetween(Year.of(1966), Year.of(1999))
        .and()
        ...
        .validBetween(Year.of(1959), Year.of(1959))
        .and()
        .hasFixedHoliday("IMPERIAL_DAY", FEBRUARY, 24)
        .validBetween(Year.of(1989), Year.of(1989))
        .and()
        .hasFixedHoliday("IMPERIAL_DAY", NOVEMBER, 12)
        .validBetween(Year.of(1990), Year.of(1990))
        .and()
