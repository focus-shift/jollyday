...
class SubdivisionsTest {
  ...
  private static final List<String> noneIso3166Countries =
      List.of(
          "DJ_STOXX",
          "LME",
          "NYSE",
          ...
          "FR",
          "MC");
  private static final List<String> okSubdivisions =
      List.of(
          "FI-01", "ES-RI", "IN-DH", "IN-OD", "IN-UK", "IN-CG", "IN-LA", "IN-TS", "SM-03", "SM-04",
          "SM-05", "SM-06", "SM-08");
    ...
    Arrays.stream(HolidayCalendar.values())
        ...
        .forEach(
            holidayCalendar -> {
              ...
              final Collection<CountrySubdivision.EnumVal> subdivisionVector =
                  JavaConverters.asJavaCollection(ISOCountrySubdivision.fromCountry(enumVal));
              final List<String> subdivisions =
                  subdivisionVector.stream().map(CountrySubdivision.EnumVal::toString).toList();
              ...
              getInstance(create(holidayCalendar))
                  ...
                  .forEach(
                      subdivision -> {
                        final String subdivisionWithCountry =
                            holidayCalendar.getId() + "-" + subdivision.toUpperCase();
