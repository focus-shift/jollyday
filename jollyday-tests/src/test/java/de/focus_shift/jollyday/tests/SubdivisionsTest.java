...
class SubdivisionsTest {
  ...
  private static final List<String> noneIso3166Countries = List.of("DJ_STOXX", "LME", "NYSE", "NYSE_EURONEXT", "TARGET", "TARGET2_SECURITIES", "XK", "FR", "MC", "GT", "VN", "CD", "SC", "MR", "TD", "SS", "ZM");
