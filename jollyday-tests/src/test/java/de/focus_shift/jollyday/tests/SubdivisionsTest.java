...
class SubdivisionsTest {
  ...
  private static final List<String> noneIso3166Countries = List.of("DJ_STOXX", "LME", "NYSE", "NYSE_EURONEXT", "TARGET", "TARGET2_SECURITIES", "XK", "FR", "MC", "GT", "VN", "CD", "SC", "MR", "TD", "SS", "ZM", "SD");
  private static final List<String> okSubdivisions = List.of("FI-01", "ES-RI", "IN-DH", "IN-OD", "IN-UK", "IN-CG", "IN-LA", "IN-TS", "SM-03", "SM-04", "SM-05", "SM-06", "SM-08", "GL-AV", "GL-QT", "SB-CH", "SB-RB", "SB-TE");
