...
class HolidayNGTest {
  ...
  void ensuresHolidays() {
    assertFor(NIGERIA)
      ...
      .hasFixedHoliday("CHILDRENS_DAY", MAY, 27).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("FREEDOM_DEMOCRACY", MAY, 29).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("INDEPENDENCE_DAY", OCTOBER, 1).validBetween(YEAR_FROM, YEAR_TO).and()
