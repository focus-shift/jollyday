...
class HolidayCHTest {
  ...
  void ensuresHolidays() {
    assertFor(SWITZERLAND)
        ...
        .and()
        .hasFixedHoliday("ST_BERCHTHOLD", JANUARY, 2, BANK_HOLIDAY)
        .and()
        .hasFixedHoliday("NATIONAL_DAY", AUGUST, 1)
        .and()
        ...
        /* Innerrhoden */
        .hasFixedHoliday("ASSUMPTION_DAY", AUGUST, 15, OBSERVANCE)
        .inSubdivision("ai")
        .and()
        .hasFixedHoliday("MAURITIUS_DAY", SEPTEMBER, 22)
        .inSubdivision("ai")
        .and()
        .hasFixedHoliday("ALL_SAINTS", NOVEMBER, 1, OBSERVANCE)
        .inSubdivision("ai")
        .and()
        .hasFixedHoliday("IMMACULATE_CONCEPTION", DECEMBER, 8, OBSERVANCE)
        .inSubdivision("ai")
        .and()
        .hasFixedHoliday("STEPHENS", DECEMBER, 26)
        .inSubdivision("ai")
        ...
        /* Genève */
        .hasFixedHoliday("RESTORATION_OF_THE_REPUBLIC", DECEMBER, 31)
        .inSubdivision("ge")
        .and()
        .hasChristianHoliday("GOOD_FRIDAY")
        .inSubdivision("ge")
        ...
        .inSubdivision("ju")
        .and()
        .hasFixedHoliday("INDEPENDENCE_DAY", JUNE, 23)
        .inSubdivision("ju")
        .and()
        .hasFixedHoliday("ASSUMPTION_DAY", AUGUST, 15, OBSERVANCE)
        .inSubdivision("ju")
        ...
        /* Luzern */
        .hasFixedHoliday("ST_JOSEPH", MARCH, 19, OBSERVANCE)
        .inSubdivision("lu")
        .and()
        .hasFixedHoliday("ASSUMPTION_DAY", AUGUST, 15)
        .inSubdivision("lu")
        ...
        /* Neuchâtel */
        .hasFixedHoliday("REPUBLIC_DAY", MARCH, 1)
        .inSubdivision("ne")
        .and()
        .hasFixedHoliday("LABOUR_DAY", MAY, 1)
        .inSubdivision("ne")
        ...
        .inSubdivision("ow")
        .and()
        .hasFixedHoliday("ST_NICHOLAS", SEPTEMBER, 25)
        ...
        .inSubdivision("ow")
        .and()
        .hasChristianHoliday("WHIT_MONDAY", OBSERVANCE)
        .inSubdivision("ow")
        .and()
        .hasChristianHoliday("CORPUS_CHRISTI")
        .inSubdivision("ow")
        ...
        /* Schwyz */
        .hasFixedHoliday("EPIPHANY", JANUARY, 6, OBSERVANCE)
        .inSubdivision("sz")
        .and()
        .hasFixedHoliday("ST_JOSEPH", MARCH, 19)
        .inSubdivision("sz")
        ...
        .inSubdivision("tg")
        .and()
        .hasFixedHoliday("LABOUR_DAY", MAY, 1, OBSERVANCE)
        .inSubdivision("tg")
        .and()
        .hasFixedHoliday("STEPHENS", DECEMBER, 26)
        .inSubdivision("tg")
        ...
        .inSubdivision("ti")
        .and()
        .hasChristianHoliday("CORPUS_CHRISTI", OBSERVANCE)
        .inSubdivision("ti")
        .and()
