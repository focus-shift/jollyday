...
import static de.focus_shift.jollyday.core.HolidayCalendar.SAINT_BARTHELEMY;
...
class HolidayBLTest {
  ...
  void ensuresHolidays() {
    assertFor(SAINT_BARTHELEMY)
      ...
      .hasFixedHoliday("ABOLITION_OF_SLAVERY", OCTOBER, 9).validBetween(YEAR_FROM, YEAR_TO).and()
