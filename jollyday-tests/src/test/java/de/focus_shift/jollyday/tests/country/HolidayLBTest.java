...
class HolidayLBTest {
  ...
  void ensuresHolidays() {
    assertFor(LEBANON)
      ...
      .hasFixedHoliday("LB_SAINTMARONS_DAY", FEBRUARY, 9).validBetween(YEAR_FROM, YEAR_TO).and()
      .hasFixedHoliday("LB_HARIRI_MEMORIAL_DAY", FEBRUARY, 14).validBetween(YEAR_FROM, YEAR_TO).and()
      ...
      .hasFixedHoliday("LB_RESISTANCE_LIBERATION_DAY", MAY, 25).validBetween(YEAR_FROM, YEAR_TO).and()
