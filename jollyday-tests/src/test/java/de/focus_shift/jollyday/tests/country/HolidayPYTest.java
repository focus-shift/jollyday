...
class HolidayPYTest {
  ...
  void ensuresHolidays() {
    assertFor(PARAGUAY)
        ...
        .and()
        .hasFixedHoliday("HEROES", MARCH, 1)
        .and()
        .hasFixedHoliday("LABOUR_DAY", MAY, 1)
        .and()
        .hasFixedHoliday("INDEPENDENCE_DAY", MAY, 15)
        .and()
        .hasFixedHoliday("CHACO_ARMISTICE", JUNE, 12)
        .and()
        .hasFixedHoliday("FOUNDING_ASUNCION", AUGUST, 15)
        .and()
        .hasFixedHoliday("VICTORY", SEPTEMBER, 29)
        .and()
