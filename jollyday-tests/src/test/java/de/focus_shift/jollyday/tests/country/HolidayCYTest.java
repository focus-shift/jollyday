...
class HolidayCYTest {
  ...
  void ensuresHolidays() {
    assertFor(CYPRUS)
        ...
        .and()
        .hasFixedHoliday("GREEK_INDEPENDENCE_DAY", MARCH, 25)
        .and()
        .hasFixedHoliday("CYPRUS_NATIONAL_DAY", APRIL, 1)
        .and()
        .hasFixedHoliday("LABOUR_DAY", MAY, 1)
        .and()
        .hasFixedHoliday("VIRGIN_MARY", AUGUST, 15)
        .and()
        .hasFixedHoliday("CYPRUS_INDEPENDENCE_DAY", OCTOBER, 1)
        .and()
        .hasFixedHoliday("OCHI", OCTOBER, 28)
        .and()
        ...
        .and()
        .hasChristianHoliday("CLEAN_MONDAY")
        .and()
