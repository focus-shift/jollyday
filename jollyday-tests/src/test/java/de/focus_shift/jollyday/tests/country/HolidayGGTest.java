  ...
  void ensuresHolidays() {
    assertFor(GUERNSEY)
      ...
      .hasFixedHoliday("LIBERATION", MAY, 10)
        .notBetween(Year.of(1900), Year.of(2009))
        .between(Year.of(2010), Year.of(2010))
        .notBetween(Year.of(2011), Year.of(2500))
      .and()
      .hasFixedHoliday("LIBERATION", MAY, 9)
        .between(Year.of(1900), Year.of(2009))
        .notBetween(Year.of(2010), Year.of(2010))
        .between(Year.of(2011), Year.of(2500))
      .and()
