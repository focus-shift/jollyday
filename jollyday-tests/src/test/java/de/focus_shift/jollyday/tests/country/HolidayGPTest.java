...
import static de.focus_shift.jollyday.core.HolidayCalendar.GUADELOUPE;
...
class HolidayGPTest {
  ...
  void ensuresHolidays() {
    assertFor(GUADELOUPE)
      ...
      .hasFixedHoliday("ABOLITION_OF_SLAVERY", MAY, 27).validBetween(YEAR_FROM, YEAR_TO).and()
