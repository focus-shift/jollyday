...
/**
 * This interface provides the way to receive the serialized holiday configuration on the base of
 * the xml files for a specific country or special calendar.
 */
public interface HolidayCalendarConfigurationService {
   ...
   *
   * <p>In most cases the configuration is based on the countries ISO code 3166.
   *
