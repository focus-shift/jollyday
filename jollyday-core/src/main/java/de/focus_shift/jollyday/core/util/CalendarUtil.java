...
public final class CalendarUtil {
  ...
  /**
   * Shows if the requested date is contained in the Set of holidays. Calls #contains(holidays,
   * date, null)
   *
  ...
  public static boolean contains(
      @NonNull final Set<Holiday> holidays, @NonNull final LocalDate date) {
        ...
        .anyMatch(
            holiday ->
                holiday.getDate().equals(date)
                    && (holidayType == null || holiday.getType() == holidayType));
  }
}
