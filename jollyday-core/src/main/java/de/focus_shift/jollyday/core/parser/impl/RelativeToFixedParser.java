 ...
 *
 * <p>Calculates the holiday date relative to a fixed date, either by moving to a specific weekday
 * or by adding/subtracting a number of days.
 *
 * <p>There are two ways this method adjusts the date:
 *
 * <ul>
 *   <li>If a weekday is given, it moves the fixed date to the next or previous occurrence of the
 *       specified weekday, depending on the relation.
 *   <li>If a number of days but no weekday is given, it adds or subtracts the specified period
 *       to/from the fixed date, depending on the relation.
 * </ul>
 *
 * <p>The resulting date is then used to create the holiday.
 */
public class RelativeToFixedParser implements HolidayParser {
  ...
  private @NonNull Holiday moveToRelativeDate(
      @NonNull final Year year, @NonNull final RelativeToFixedHolidayConfiguration rf) {
  ...
  private @NonNull LocalDate moveToWeekday(
      @NonNull final LocalDate date,
      @NonNull final DayOfWeek targetDay,
      @Nullable final Relation relation) {
  ...
  private @NonNull LocalDate moveByDays(
      @NonNull final LocalDate date, @NonNull final Days days, @Nullable final Relation relation) {
