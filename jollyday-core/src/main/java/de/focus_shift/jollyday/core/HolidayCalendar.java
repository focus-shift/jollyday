...
public enum HolidayCalendar {
  ...
  GEORGIA("GE"), GERMANY(Locale.GERMANY.getCountry()), GAMBIA("GM"), GABON("GA"), GHANA("GH"), GIBRALTAR("GI"), GRENADA("GD"), GUYANA("GY"), GUATEMALA("GT"), GUAM("GU"), GUERNSEY("GG"), GREECE("GR"), GREENLAND("GL"), GUINEA("GN"), GUINEA_BISSAU("GW"),
  ...
  OMAN("OM"),
  NAMIBIA("NA"), NAURU("NR"), NETHERLANDS("NL"), NEW_ZEALAND("NZ"), NICARAGUA("NI"), NIGER("NE"), NIGERIA("NG"), NORWAY("NO"), NYSE("NYSE"), NYSE_EURONEXT("NYSE_EURONEXT"),
