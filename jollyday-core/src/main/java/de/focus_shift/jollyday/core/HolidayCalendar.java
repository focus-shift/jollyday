...
public enum HolidayCalendar {
  ...
  SAN_MARINO("SM"), SAO_TOME_AND_PRINCIPE("ST"), SAUDI_ARABIA("SA"), SENEGAL("SN"), SERBIA("RS"), SIERRA_LEONE("SL"), SEYCHELLES("SC"), SINGAPORE("SG"), SLOWAKIA("SK"), SLOWENIA("SI"), SAMOA("WS"), SOLOMON_ISLANDS("SB"), SOMALIA("SO"), SUDAN("SD"), SOUTH_AFRICA("ZA"), SOUTH_SUDAN("SS"), SPAIN("ES"), SVALBARD_AND_JAN_MAYEN("SJ"), SAINT_BARTHELEMY("BL"), SAINT_KITTS_AND_NEVIS("KN"), SAINT_LUCIA("LC"), SAINT_VINCENT_AND_THE_GRENADINES("VC"), SURINAME("SR"), SYRIA("SY"), SWEDEN("SE"), SWITZERLAND("CH"),
