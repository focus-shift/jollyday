...
public enum HolidayCalendar {
  ...
  CAMEROON("CM"), CANADA(Locale.CANADA.getCountry()), CAYMAN_ISLANDS("KY"), CHAD("TD"), CHILE("CL"), COLOMBIA("CO"), CONGO("CD"), COSTA_RICA("CR"), CROATIA("HR"), CUBA("CU"), CZECH_REPUBLIC("CZ"), CYPRUS("CY"),
