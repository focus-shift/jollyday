...
public enum HolidayCalendar {
  ...
  ANTARCTICA("AQ"), AFGHANISTAN("AF"), ALBANIA("AL"), ALGERIA("DZ"), AMERICAN_SAMOA("AS"), ANDORRA("AD"), ANGUILLA("AI"), ANTIGUA_AND_BARBUDA("AG"), ANGOLA("AO"), ARGENTINA("AR"), ARMENIA("AM"), ARUBA("AW"), AZERBAIJAN("AZ"), AUSTRALIA("AU"), AUSTRIA("AT"),
