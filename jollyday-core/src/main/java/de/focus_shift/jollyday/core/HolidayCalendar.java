...
public enum HolidayCalendar {
  ...
  CAMEROON("CM"), CANADA(Locale.CANADA.getCountry()), CAYMAN_ISLANDS("KY"), CENTRAL_AFRICAN_REPUBLIC("CF"), CHAD("TD"), CHILE("CL"), COLOMBIA("CO"), CONGO("CD"), CONGO_REPUBLIC("CG"), COSTA_RICA("CR"), CROATIA("HR"), CUBA("CU"), CZECH_REPUBLIC("CZ"), CYPRUS("CY"),
  ...
  MACEDONIA("MK"), MADAGASCAR("MG"), MALAWI("MW"), MALI("ML"), MALTA("MT"), MAURITANIA("MR"), MONACO("MC"), MOROCCO("MA"), MAURITIUS("MU"), MEXICO("MX"), MOLDOVA("MD"), MONTENEGRO("ME"),
  ...
  TARGET("TARGET"), TARGET2_SECURITIES("TARGET2_SECURITIES"), TANZANIA("TZ"), TOGO("TG"), TUNISIA("TN"), TURKMENISTAN("TM"), TURKEY("TR"),
