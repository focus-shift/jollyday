...
public enum HolidayCalendar {
  ...
  MACEDONIA("MK"), MADAGASCAR("MG"), MALAWI("MW"), MALI("ML"), MALTA("MT"), MARSHALL_ISLANDS("MH"), MARTINIQUE("MQ"), MAURITANIA("MR"), MAYOTTE("YT"), MONACO("MC"), MOROCCO("MA"), MAURITIUS("MU"), MEXICO("MX"), MICRONESIA("FM"), MOLDOVA("MD"), MONTENEGRO("ME"), MONTSERRAT("MS"), MOZAMBIQUE("MZ"),
  OMAN("OM"),
