...
public enum HolidayCalendar {
  ...
  BAHAMAS("BS"), BANGLADESH("BD"), BARBADOS("BB"), BELARUS("BY"), BELGIUM("BE"), BERMUDA("BM"), BOTSWANA("BW"), BOLIVIA("BO"), BOSNIA_HERZIGOWINA("BA"), BRAZIL("BR"), BRITISH_VIRGIN_ISLANDS("VG"), BULGARIA("BG"),
