...
public enum HolidayCalendar {
  ...
  SAN_MARINO("SM"), SAUDI_ARABIA("SA"), SERBIA("RS"), SEYCHELLES("SC"), SINGAPORE("SG"), SLOWAKIA("SK"), SLOWENIA("SI"), SOUTH_AFRICA("ZA"), SOUTH_SUDAN("SS"), SPAIN("ES"), SURINAME("SR"), SWEDEN("SE"), SWITZERLAND("CH"),
