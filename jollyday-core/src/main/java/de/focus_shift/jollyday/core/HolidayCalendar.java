...
public enum HolidayCalendar {
  ...
  ANTARCTICA("AQ"), ALBANIA("AL"), ALGERIA("DZ"), ANDORRA("AD"), ARGENTINA("AR"), ARMENIA("AM"), AUSTRALIA("AU"), AUSTRIA("AT"),
  BAHAMAS("BS"), BANGLADESH("BD"), BARBADOS("BB"), BELARUS("BY"), BELGIUM("BE"), BENIN("BJ"), BERMUDA("BM"), BOTSWANA("BW"), BOLIVIA("BO"), BOSNIA_HERZIGOWINA("BA"), BRAZIL("BR"), BRITISH_VIRGIN_ISLANDS("VG"), BULGARIA("BG"),
  CANADA(Locale.CANADA.getCountry()), CAYMAN_ISLANDS("KY"), CHAD("TD"), CHILE("CL"), COLOMBIA("CO"), CONGO("CD"), COSTA_RICA("CR"), CROATIA("HR"), CUBA("CU"), CZECH_REPUBLIC("CZ"), CYPRUS("CY"),
  ...
  GEORGIA("GE"), GERMANY(Locale.GERMANY.getCountry()), GAMBIA("GM"), GHANA("GH"), GIBRALTAR("GI"), GUYANA("GY"), GUATEMALA("GT"), GUERNSEY("GG"), GREECE("GR"), GREENLAND("GL"),
  ...
  NETHERLANDS("NL"), NEW_ZEALAND("NZ"), NICARAGUA("NI"), NIGER("NE"), NIGERIA("NG"), NORWAY("NO"), NYSE("NYSE"), NYSE_EURONEXT("NYSE_EURONEXT"),
  PANAMA("PA"), PARAGUAY("PY"), PERU("PE"), POLAND("PL"), PORTUGAL("PT"),
  ROMANIA("RO"), RUSSIA("RU"),
  SAN_MARINO("SM"), SAUDI_ARABIA("SA"), SENEGAL("SN"), SERBIA("RS"), SEYCHELLES("SC"), SINGAPORE("SG"), SLOWAKIA("SK"), SLOWENIA("SI"), SUDAN("SD"), SOUTH_AFRICA("ZA"), SOUTH_SUDAN("SS"), SPAIN("ES"), SURINAME("SR"), SWEDEN("SE"), SWITZERLAND("CH"),
