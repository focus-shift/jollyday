...
public enum HolidayCalendar {
  ...
  MACEDONIA("MK"), MADAGASCAR("MG"), MALTA("MT"), MAURITANIA("MR"), MONACO("MC"), MOROCCO("MA"), MAURITIUS("MU"), MEXICO("MX"), MOLDOVA("MD"), MONTENEGRO("ME"),
  ...
  SAN_MARINO("SM"), SAUDI_ARABIA("SA"), SERBIA("RS"), SEYCHELLES("SC"), SINGAPORE("SG"), SLOWAKIA("SK"), SLOWENIA("SI"), SOUTH_AFRICA("ZA"), SPAIN("ES"), SURINAME("SR"), SWEDEN("SE"), SWITZERLAND("CH"),
