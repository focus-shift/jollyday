...
public enum HolidayCalendar {
  ...
  BAHAMAS("BS"), BANGLADESH("BD"), BAHRAIN("BH"), BARBADOS("BB"), BELARUS("BY"), BELGIUM("BE"), BELIZE("BZ"), BENIN("BJ"), BERMUDA("BM"), BOLIVIA("BO"), BONAIRE_SINT_EUSTATIUS_AND_SABA("BQ"), BOSNIA_HERZIGOWINA("BA"), BOTSWANA("BW"), BRAZIL("BR"), BRITISH_VIRGIN_ISLANDS("VG"), BULGARIA("BG"), BURUNDI("BI"), BURKINA_FASO("BF"),
