...
/**
 * Represents the configuration of a holiday that has a fixed weekday in a month based on its
 ...
 * </ul>
 *
 * <p>Example: The first Saturday in January.
 *
 * <p>The {@link de.focus_shift.jollyday.core.parser.impl.FixedWeekdayInMonthParser} is used.
 */
