...
class CalculateEasterSundayTest {
  ...
  void ensureThatJulianEasterCalculationWasChosenByJulianChronology() {
    final LocalDate julianEasterSunday =
        new CalculateEasterSunday(Year.of(2005)).apply(JulianChronology.INSTANCE);
  ...
  void ensureThatGregorianEasterCalculationWasChosenByGregorianChronology() {
    final LocalDate gregorianEasterSunday =
        new CalculateEasterSunday(Year.of(2005)).apply(IsoChronology.INSTANCE);
  ...
  void ensureThatGregorianEasterCalculationWasChosenByUnknownChronologySince1584() {
    final LocalDate gregorianEasterSunday =
        new CalculateEasterSunday(Year.of(1584)).apply(MinguoChronology.INSTANCE);
  ...
  void ensureThatJulianEasterCalculationWasChosenByUnknownChronologyUntil1583() {
    final LocalDate julianEasterSunday =
        new CalculateEasterSunday(Year.of(1583)).apply(MinguoChronology.INSTANCE);
