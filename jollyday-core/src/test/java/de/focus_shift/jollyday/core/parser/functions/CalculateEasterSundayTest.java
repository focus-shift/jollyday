...
class CalculateEasterSundayTest {
  ...
  void ensureThatJulianEasterCalculationWasChosenByJulianChronology() {
    final LocalDate julianEasterSunday = new CalculateEasterSunday(2005).apply(JulianChronology.INSTANCE);
  ...
  void ensureThatGregorianEasterCalculationWasChosenByGregorianChronology() {
    final LocalDate gregorianEasterSunday = new CalculateEasterSunday(2005).apply(IsoChronology.INSTANCE);
  ...
  void ensureThatGregorianEasterCalculationWasChosenByUnknownChronologySince1584() {
    final LocalDate gregorianEasterSunday = new CalculateEasterSunday(1584).apply(MinguoChronology.INSTANCE);
  ...
  void ensureThatJulianEasterCalculationWasChosenByUnknownChronologyUntil1583() {
    final LocalDate julianEasterSunday = new CalculateEasterSunday(1583).apply(MinguoChronology.INSTANCE);
