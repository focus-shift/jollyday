...
class FixedParserTest {
  ...
  class LimitedTests {
    ...
    void ensureThatFixedAreLimitedAndIsValid() {
      ...
      final FixedHolidayConfiguration fixed =
          getFixed(MonthDay.of(JANUARY, 5), Year.of(2022), Year.of(2022), EVERY_YEAR);
    ...
    void ensureThatFixedAreLimitedAndIsInvalid() {
      ...
      final FixedHolidayConfiguration fixed =
          getFixed(MonthDay.of(JANUARY, 5), Year.of(2023), Year.of(2023), EVERY_YEAR);
  ...
  class MovableTests {
    ...
    void ensureThatFixedAreMovable() {
      ...
      assertThat(calculatedHoliday.get(0).getActualDate())
          .isEqualTo(LocalDate.of(2025, JANUARY, 5));
      ...
      assertThat(calculatedHoliday.get(0).getObservedDate())
          .hasValue(LocalDate.of(2025, JANUARY, 6));
      assertThat(calculatedHoliday.get(0).getObservedDate())
  ...
  private static FixedHolidayConfiguration getFixed(
      final MonthDay day, final Movable.MovingCondition movingCondition) {
