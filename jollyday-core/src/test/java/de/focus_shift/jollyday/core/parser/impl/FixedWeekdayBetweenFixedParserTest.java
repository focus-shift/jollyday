...
class FixedWeekdayBetweenFixedParserTest {
  ...
  class LimitedTests {
    ...
    void ensureThatFixedWeekdayBetweenFixedAreLimitedAndIsValid() {
      ...
      final FixedWeekdayBetweenFixedHolidayConfiguration fixedWeekdayBetweenFixed =
          getFixedWeekdayBetweenFixed(
              MonthDay.of(JANUARY, 6), MonthDay.of(JANUARY, 12), WEDNESDAY, year, year);
