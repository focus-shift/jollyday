...
class CalculateRelativeDatesFromChronologyWithinGregorianYearTest {
  ...
  void testCalendarIslamicNewYear() {
    final Stream<LocalDate> holidays =
  ...
  void testCalendarIslamicAschura2008() {
    ...
    assertThat(holidays).containsExactly(LocalDate.of(2008, JANUARY, 19));
  }
  ...
  void testCalendarIslamicIdAlFitr2008() {
    ...
    assertThat(holidays).containsExactly(LocalDate.of(2008, OCTOBER, 1));
  }
  ...
  void testCalendarIslamicIdAlFitr2009() {
    ...
    assertThat(holidays).containsExactly(LocalDate.of(2009, SEPTEMBER, 20));
  }
}
