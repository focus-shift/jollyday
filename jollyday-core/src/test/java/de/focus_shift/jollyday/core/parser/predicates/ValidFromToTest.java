...
class ValidFromToTest {
  ...
  @Property
  void ensureFromCanBeNullAndToIsAYearAndWillBeValidUntilTo(
      @ForAll @YearRange(max = 2020) final Year year) {
  ...
  void ensureFromBothBeNullAndToIsAYearAfter2020AndWillNotBeValid(
      @ForAll @YearRange(min = 2021) final Year year) {
    final Limited limited = getLimited(null, Year.of(2020));
  ...
  @Property
  void ensureToCanBeNullAndFromIsSetAndLimitedWillBeValidUntilThisYear(
      @ForAll @YearRange(min = 1900) final Year year) {
  ...
  @Property
  void ensureToCanBeNullAndFromIsSetAndLimitedWillBeNotValidAfterThisYear(
      @ForAll @YearRange(min = 1800, max = 1899) final Year year) {
    final Limited limited = getLimited(Year.of(1900), null);
  ...
  @Property
  void ensureIsOnlyValidInTheIntervalFromAndTo(
      @ForAll @YearRange(min = 1920, max = 2080) final Year year) {
  ...
  void ensureIsNotValidBeforeTheIntervalFromAndTo(
      @ForAll @YearRange(min = 1700, max = 1919) final Year year) {
    final Limited limited = getLimited(Year.of(1920), Year.of(2080));
  ...
  @Property
  void ensureIsNotValidAfterTheIntervalFromAndTo(
      @ForAll @YearRange(min = 2081, max = 2150) final Year year) {
