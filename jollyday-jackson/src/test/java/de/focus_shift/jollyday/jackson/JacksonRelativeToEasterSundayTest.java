...
class JacksonRelativeToEasterSundayTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    final JacksonRelativeToEasterSunday jacksonRelativeToEasterSunday =
        new JacksonRelativeToEasterSunday(relativeToEasterSunday);
    ...
    assertThat(jacksonRelativeToEasterSunday.descriptionPropertiesKey())
