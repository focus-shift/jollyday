...
class JacksonRelativeToFixedTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    relativeToFixed.setLocalizedType(
    ...
    final JacksonRelativeToFixed jacksonRelativeToFixed =
        new JacksonRelativeToFixed(relativeToFixed);
    assertThat(jacksonRelativeToFixed.date().day())
        .isEqualTo(MonthDay.of(java.time.Month.JANUARY, 1));
    ...
    assertThat(jacksonRelativeToFixed.descriptionPropertiesKey())
        .isEqualTo("relative.fixed.description");
  ...
  void ensureToReturnNullOrDefaultValuesOnNotSetValues() {
    ...
    final JacksonRelativeToFixed jacksonRelativeToFixed =
        new JacksonRelativeToFixed(relativeToFixed);
    assertThat(jacksonRelativeToFixed.date().day())
        .isEqualTo(MonthDay.of(java.time.Month.FEBRUARY, 10));
