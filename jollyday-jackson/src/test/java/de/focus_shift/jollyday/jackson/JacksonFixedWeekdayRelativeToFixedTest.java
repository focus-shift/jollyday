...
class JacksonFixedWeekdayRelativeToFixedTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    final FixedWeekdayRelativeToFixed fixedWeekdayRelativeToFixed =
        new FixedWeekdayRelativeToFixed();
    ...
    final JacksonFixedWeekdayRelativeToFixed jacksonFixedWeekdayRelativeToFixed =
        new JacksonFixedWeekdayRelativeToFixed(fixedWeekdayRelativeToFixed);
    assertThat(jacksonFixedWeekdayRelativeToFixed.day().day())
        .isEqualTo(MonthDay.of(java.time.Month.APRIL, 15));
    ...
    assertThat(jacksonFixedWeekdayRelativeToFixed.descriptionPropertiesKey())
        .isEqualTo("relative.description");
    assertThat(jacksonFixedWeekdayRelativeToFixed.holidayType())
        .isEqualTo(HolidayType.BANK_HOLIDAY);
  ...
  void ensureToReturnNullOrDefaultValuesOnNotSetValues() {
    ...
    final JacksonFixedWeekdayRelativeToFixed jacksonFixedWeekdayRelativeToFixed =
        new JacksonFixedWeekdayRelativeToFixed(fixedWeekdayRelativeToFixed);
    assertThat(jacksonFixedWeekdayRelativeToFixed.day().day())
        .isEqualTo(MonthDay.of(java.time.Month.MAY, 5));
    ...
    assertThat(jacksonFixedWeekdayRelativeToFixed.holidayType())
        .isEqualTo(HolidayType.PUBLIC_HOLIDAY);
