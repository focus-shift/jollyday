...
class JacksonFixedWeekdayInMonthTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    final JacksonFixedWeekdayInMonth jacksonFixedWeekdayInMonth =
        new JacksonFixedWeekdayInMonth(fixedWeekdayInMonth);
    ...
    assertThat(jacksonFixedWeekdayInMonth.descriptionPropertiesKey())
        .isEqualTo("weekdayinmonth.description");
    assertThat(jacksonFixedWeekdayInMonth.holidayType())
