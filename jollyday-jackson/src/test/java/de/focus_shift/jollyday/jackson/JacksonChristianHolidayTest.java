...
class JacksonChristianHolidayTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    christianHoliday.setLocalizedType(
  ...
  void ensureToReturnNullOrDefaultValuesOnNotSetValues() {
    final ChristianHoliday christianHoliday = new ChristianHoliday();
    christianHoliday.setType(
        de.focus_shift.jollyday.jackson.mapping.ChristianHolidayType.GOOD_FRIDAY);

    final JacksonChristianHoliday jacksonChristianHoliday =
        new JacksonChristianHoliday(christianHoliday);
    ...
    assertThat(jacksonChristianHoliday.descriptionPropertiesKey())
        .isEqualTo("christian.GOOD_FRIDAY");
