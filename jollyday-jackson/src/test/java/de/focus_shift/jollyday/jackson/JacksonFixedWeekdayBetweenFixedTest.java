...
class JacksonFixedWeekdayBetweenFixedTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    final JacksonFixedWeekdayBetweenFixed jacksonFixedWeekdayBetweenFixed =
        new JacksonFixedWeekdayBetweenFixed(fixedWeekdayBetweenFixed);
    ...
    assertThat(jacksonFixedWeekdayBetweenFixed.descriptionPropertiesKey())
        .isEqualTo("between.description");
    assertThat(jacksonFixedWeekdayBetweenFixed.holidayType())
