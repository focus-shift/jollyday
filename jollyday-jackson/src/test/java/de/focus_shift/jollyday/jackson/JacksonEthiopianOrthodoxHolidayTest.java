...
class JacksonEthiopianOrthodoxHolidayTest {
  ...
  void ensureFieldsAreSetAndMappedCorrectly() {
    ...
    ethiopianOrthodoxHoliday.setType(
        de.focus_shift.jollyday.jackson.mapping.EthiopianOrthodoxHolidayType.TIMKAT);
    ...
    final JacksonEthiopianOrthodoxHoliday jacksonEthiopianOrthodoxHoliday =
        new JacksonEthiopianOrthodoxHoliday(ethiopianOrthodoxHoliday);
    assertThat(jacksonEthiopianOrthodoxHoliday.type())
        .isEqualTo(EthiopianOrthodoxHolidayType.TIMKAT);
    assertThat(jacksonEthiopianOrthodoxHoliday.cycle()).isEqualTo(YearCycle.ODD_YEARS);
    assertThat(jacksonEthiopianOrthodoxHoliday.descriptionPropertiesKey())
        .isEqualTo("ethiopian.description");
    assertThat(jacksonEthiopianOrthodoxHoliday.holidayType())
        .isEqualTo(de.focus_shift.jollyday.core.HolidayType.BANK_HOLIDAY);
  ...
  void ensureToReturnNullOrDefaultValuesOnNotSetValues() {
    ...
    assertThat(jacksonEthiopianOrthodoxHoliday.descriptionPropertiesKey())
        .isEqualTo("ethiopian.orthodox.TIMKAT");
    assertThat(jacksonEthiopianOrthodoxHoliday.holidayType())
        .isEqualTo(de.focus_shift.jollyday.core.HolidayType.PUBLIC_HOLIDAY);
