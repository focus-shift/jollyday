...
public class Holidays {
   ...
   * object. This is why there is not a <CODE>set</CODE> method for the fixed property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Fixed }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the Jakarta XML Binding
   * object. This is why there is not a <CODE>set</CODE> method for the relativeToFixed property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link RelativeToFixed }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the Jakarta XML Binding
   * object. This is why there is not a <CODE>set</CODE> method for the relativeToWeekdayInMonth
   * property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link RelativeToWeekdayInMonth }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the Jakarta XML Binding
   * object. This is why there is not a <CODE>set</CODE> method for the fixedWeekday property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link FixedWeekdayInMonth }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the Jakarta XML Binding
   * object. This is why there is not a <CODE>set</CODE> method for the christianHoliday property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ChristianHoliday }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the Jakarta XML Binding
   * object. This is why there is not a <CODE>set</CODE> method for the islamicHoliday property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link IslamicHoliday }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the Jakarta XML Binding
   * object. This is why there is not a <CODE>set</CODE> method for the fixedWeekdayBetweenFixed
   * property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link FixedWeekdayBetweenFixed }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the Jakarta XML Binding
   * object. This is why there is not a <CODE>set</CODE> method for the fixedWeekdayRelativeToFixed
   * property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link FixedWeekdayRelativeToFixed
   * }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the Jakarta XML Binding
   * object. This is why there is not a <CODE>set</CODE> method for the ethiopianOrthodoxHoliday
   * property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link EthiopianOrthodoxHoliday }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the Jakarta XML Binding
   * object. This is why there is not a <CODE>set</CODE> method for the relativeToEasterSunday
   * property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link RelativeToEasterSunday }
   */
