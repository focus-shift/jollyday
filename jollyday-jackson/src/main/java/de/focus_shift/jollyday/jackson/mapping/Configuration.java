...
public class Configuration {
  ...
  protected List<Weekend> weekend;
   ...
   * returned list will be present inside the Jackson object.
   * This is why there is not a <CODE>set</CODE> method for the weekend property.
   *
   * <p>
